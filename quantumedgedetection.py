...
imageNames = ["100023.jpg", "100037.jpg", "100042.jpg","100085.jpg"]
imageNum1 = 0
imageNum2 = 2

image1 = Image.open(imageNames[imageNum1]).convert('LA')
#image2 = Image.open(imageNames[imageNum2]).convert('LA')
#gr_im= Image.fromarray(np.array(image1)).save('test1.png')
#gr2_im= Image.fromarray(image2).save('test2.png')
print("==================")
